...
" si usted trabaja con el autocompletado KITE, descomente la sgt línea y especifique las extensiones con que trabajará
...
" cerrar automaticamente la barra lateral o árbol cada vez que se abra un archivo
...
"*--------------------- FUNCIÓN PARA ABRIR LA TERMINAL DENTRO DE NVIM -------------------------*

function! OpenTerminal()
  " mover búfer hacia la derecha
  execute "normal \<C-l>"
  execute "normal \<C-l>"
  execute "normal \<C-l>"
  execute "normal \<C-l>"
